...
const config = {
  SESSION_ID: process.env.SESSION_ID || "RCD-MD&StYRrHmW",
  AUTO_STATUS_SEEN: process.env.AUTO_STATUS_SEEN !== undefined ? process.env.AUTO_STATUS_SEEN === 'true' : true,
  STATUS_SEND_RAW_URL: process.env.STATUS_SEND_RAW_URL || "https://raw.githubusercontent.com/rcd-git-hub-official/status-send-raw-list/main/Heshan.text",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "HEDHAN☠",
  SUDO_NUMBER: process.env.OWNER_NUMBER || "94719845166",
